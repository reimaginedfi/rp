...
const value = useContext(VaultData);
  ...
  const previewAum = value!.totalBalance;
  // value!.totalAum > value!.totalBalance ? value!.totalAum :
  ...
  // console.log("YESDADAS", value?.totalAum)
  // console.log("Y####", value?.totalBalance)
